...
export default function NewProduct() {
  ...
  const { createProduct, isLoading, error } = useAdminProductStore();
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 truncate">Add New Product</h1>
                <p className="text-gray-600 text-xs sm:text-sm lg:text-base mt-1">Create a new product for your store</p>
              </div>
            </div>
          </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <textarea
                        ...
                        className={`w-full px-3 py-2 text-black border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none ${
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p><span className="font-medium text-black">Name:</span> <span className="text-black">{watchedValues.name || 'Not provided'}</span></p>
                    <p><span className="font-medium text-black">Category:</span> <span className="text-black">{watchedValues.category || 'Not selected'}</span></p>
                    <p><span className="font-medium text-black">Price:</span> <span className="text-black">${watchedValues.price || '0.00'}</span></p>
                    <p><span className="font-medium text-black">Stock:</span> <span className="text-black">{watchedValues.stock || '0'}</span></p>
                    <p><span className="font-medium text-black">Status:</span> <span className="text-black">{watchedValues.published ? 'Published' : 'Draft'}</span></p>
                    <p><span className="font-medium text-black">Featured:</span> <span className="text-black">{watchedValues.featured ? 'Yes' : 'No'}</span></p>
                    <p><span className="font-medium text-black">Images:</span> <span className="text-black">{images.length} uploaded</span></p>
                  </div>
                </div>
                <div>
